                        ...
                        <div class="element-box">
							...
							<div class="table-responsive">
								<table class="table table-striped table-hovered">
				                    ...
				                    <tbody>
										<form method="post" action="<?= base_url('cartprogramicanupgrade/update'); ?>">
										<?php 
											if(!empty($items)){
											$index = 0;
				                        ...
				                        <tr class="text-center">
											...
											<?php } else { ?>
				                            <td>
												<!-- <a href="<?= base_url('cartprogramicanupgade/remove_one/' . $row['id']);?>" class="btn bgmerahhati text-white btn-sm">-</a>  -->
												<?php // echo $row['quantity']; ?> 
				                            ...
				                            <td class="text-center">
												<!-- <a href="<?php echo site_url('cartprogram/removeitem/'.$row['id']); ?>"><i class="fa fa-trash merahhati"></i></a> -->
												<a href="<?php echo site_url('cartprogram/removeitem/'.$row['id']); ?>" style="color: red;" >Hapus Program</a>
				                            </td>
