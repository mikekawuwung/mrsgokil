														...
														<div class="row">
															<div class="col-md-6">
																...
																<div class="mt-3 wajib">
																	<label>No HP<small><span style="color:red;"> *required</span></small></label><br>
...
// 			var phoneibu = $('#phoneibu').val();
            ...
            if(orangTua1 == 'ayah') {
                ...
                console.log('dataOrangTuaAyah ' + dataAyah);
                console.log('dataOrangTuaIbu ' + dataIbu);
			...
			for (var i = 0; i < length; i++) {
				...
				var scheduleList = '';
				dataItems[i]['schedules'].forEach((item, index) => {
					scheduleList += item.short_name;
					if(index != dataItems[i]['schedules'].length - 1) {
						scheduleList += ', ';
						// scheduleList += ' ';
					}
				});
				stringProduct += dataItems[i]['program_name'] + ' ' + dataItems[i]['quantity'] + ' (' + scheduleList + '), ';
				// end here schedule
				...
				// stringProductDash += dataItems[i]['program_name'] + ' (' + scheduleList + ') ' + ' - ' + dataItems[i]['quantity'] + ', ';
				...
				if(dataItems[i]['id'] == 35 && dataItems[i]['quantity'] >= 2) {
				    var item = {};
			...
			// var string_peserta = programQuantity;
			...
			var index = 0;
			// setProgramQuantity.forEach((item, index) => {
