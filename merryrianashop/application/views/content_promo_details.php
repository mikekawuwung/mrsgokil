                    ...
                    <div class="element-wrapper">
                        <div class="element-box">
                        	<div class="element-info">
                        		<a href="<?= base_url('promo'); ?>" class="btn btn-default btn-sm borbgmerahhati text-white"><i class="fa fa-arrow-left text-white"></i>
                        			Kembali
                        		</a>
							</div>
                            <?php 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="card-img-top" src="<?= $promo->img; ?>" alt=""/>
                                </div>
                                
                                <div class="col-md-6">
                                    <h3 class="element-inner-header text-center"><?= $promo->promo_name ?></h3>
                                    <hr>
                                    <p>
										<?= $promo->deskripsi; ?>
									</p>
                                    <!-- <p class="float-left" style="font-size:20px;">Rp <?php //echo number_format($promo->price) ?></p> -->
                                    <br><br><br>
									<?php if($promo->sts == "aktif") {?>
                                    <a href="<?php echo site_url('cartpromo/buy/'.$promo->id); ?>">
