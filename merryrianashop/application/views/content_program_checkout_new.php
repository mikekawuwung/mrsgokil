																	...
																	?>
																			<tr>
																				...
																				<th scope="col">
																					...
																					<a href="<?= base_url('cartprogram/remove_one/' . $row['id']); ?>" class="btn bgmerahhati text-white btn-sm">-</a>
																					<?= $row['quantity'] ?>
																					<a href="<?= base_url('cartprogram/add_one/' . $row['id']); ?>" class="btn bgmerahhati text-white btn-sm">+</a>
																				</th>
