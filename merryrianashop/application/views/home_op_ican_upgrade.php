  ...
  <head>
	...
	<script type="text/javascript" class="init">
		...
		function open_modal_size(id) {
			...
			var newurl = "<?php echo site_url('cartprogram/buy/'); ?>" + id;
		...
		function send() {
			...
			var newurl = "<?php echo site_url('cartprogram/buy/'); ?>" + id + "?Ukuran=" + ukuran;
			...
			<div class="row">
				...
				<div class="element-wrapper">
							...
							<div class="row align-items-center">
								<div class="col-sm-8">
									...
									<div class="element-info-text">
										<h5 class="element-inner-header">Program</h5>
										<div class="element-inner-desc">
										Yuk selalu termotivasi dengan Program Miss Merry riana.
										</div>
									</div>
									</div>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-3" id="main">
							...
							<div class="card" style="margin-bottom:10px;">
								<a href="<?= base_url('online_program_ican_upgrade/detail?id=' . $product->id) ?>"><img class="card-img-top" src="<?= base_url('assets/img/merchandise/'. $product->img); ?>" alt=""/></a>
								<div class="card-body">
								<a href="<?= base_url('online_program_ican_upgrade/detail?id=' . $product->id) ?>">
									<p class="card-title merahhati" style="font-weight:bold; font-size:13px;"><?= $product->program_name ?></p>
								</a>
								...
								<div class="card-footer borbgmerahhati" style="font-weight: 400;outline: none;color: #fff;">
									...
									<?php } else { ?>
									<a href="<?php echo site_url('cartprogramicanupgrade/buy/'.$product->id); ?>">
									...
									<?php } ?>
									<!-- end here size -->
								<!--<a href="<?php// echo site_url('cartprogram//buy/'.$product->id); ?>">-->
								<!--	<button type="button" class="btn btn-sm btn-default float-left">-->
								<!--		<i class="fa fa-shopping-cart"></i> Add to Cart-->
								<!--	</button>-->
								<!--</a>-->
					...
					<div class="row">
						...
						<div class="col-md-3">
						<a href="#" target="_blank"><button class="btn btn-info borbgmerahhati" style="width: 100%;height: 100%;font-size: 1.5em;font-weight: bold;cursor:pointer;"> Dapatkan Sekarang </button></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
				<!-- <a id="set_url" href="<?php //echo site_url('cartprogram//buy/'.$product->id); ?>"> -->
