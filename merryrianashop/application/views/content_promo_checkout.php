                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card mb-3 w-100">
                                        <div class="card-header bgmerahhati text-white">Promo Form</div>
										...
										<!-- <div class="mt-3">
                                            ...
                                            <input class="form-control" value="" id="catatan" name="catatan" type="text" placeholder="">
                                        </div> -->
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <tbody>
														...
														?>
                                                        <tr>
                                                            <th scope="col"><?= $row['promo_name'] ?></th>
                                                            <!-- <th scope="col"><?php // $row['quantity'] ?></th>
															<th scope="col"><?php // $row['price']*$row['quantity'] ?></th> -->
															<th scope="col"><a href="<?php echo site_url('cartpromo/remove/'.$row['id']); ?>">X</a></th>
                                                        </tr>
														<?php } } ?>
                                                        <tr>
                                                            <!-- <th scope="col"><b>Total</b></th> -->
                                                            <!-- <th scope="col"><b></b></th> -->
															<!-- <th scope="col" id="totalharga"><b><?php // $total ?></b></th> -->
															<!-- <th scope="col"></td> -->
                                                        </tr>
														<!-- <tr>
                                                        ...
                                                        <!-- <tr>
                                                            <th scope="col"><b>Total</b></th>
                                                            <th scope="col"><b></b></th>
                                                            <th scope="col" id="totalharga"><b><?php //echo $total ?></b></th>
                                                            <th scope="col"></th>
                                                        </tr> -->
                                                    </tbody>
                                                </table>
                                                <div class="card">
                                                    <div class="card-body">
                                                        <b>Data akan dikirim ke database kami</b>
                                                        <footer class="blockquote-footer">Kami akan segera menghubungi Anda.</footer>
                                                    </div>
                                                    <div class="card-footer">
                                                    	<!-- <a href="<?php //base_url('promo'); ?>" class="btn btn-default btn-sm borbgmerahhati text-uppercase text-white">Tambah Pesanan</a> -->
                                                        <button id="pay-button" class="btn btn-default btn-sm borbgmerahhati text-uppercase text-white float-right">Kirim Sekarang</button>    
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
	...
	function fetch_kota() {
		...
		$.ajax({
			url: "http://merryriana.com/server_api/kota",
			type: "POST",
			dataType: "json",
			data: {
	...
	function fetch_harga() {
		...
		// console.log(dataBerat);
		$.ajax({
			url: "http://merryriana.com/server_api/cost",
			type: "POST",
			dataType: "json",
			data: JSON.stringify(dataBerat),
			success: function(result) {
	...
	$('#pay-button').click(function (event) {
		...
		var dataCustomer = {
							id_buku: "Promo Sosmed ",
							name: name,
							email: email,
							phone: phone,
							shipping_details: "null",
							// shipping_details: alamat + ' ' + kota + ' ' + provinsi + ' ' + ekspedisi, // kecamatan
							source: "m1",
							code: "end",
							campaign: "endorse",
		...
		for(var i=0; i<length; i++) {
			var item = {};
			stringProduct += dataItems[i]['promo_name'] + ' ' + dataItems[i]['quantity'] + ', ';
			item.id = dataItems[i]['id'];
			item.judul = dataItems[i]['promo_name'];
			item.gambar = dataItems[i]['img'];
			item.deskripsi = dataItems[i]['deskripsi'];
			item.kategori = "Sosmed";
		...
		$.ajax({
		  ...
		  success: function(response) {
			...
			$.ajax({
				url: "<?php // echo base_url('cartpromo/clear'); ?>",
				type: "GET",
				success: function(response) {
					console.log("Clear");
				}
...
// 		});
		...
		// $.ajax({
		//   url: "http://m1.merryriana.com/post_data/update_address",
		//   type : "POST",
		//   data: {
        //             'id_buku': dataCustomer.id_buku,
        //             'name': name,
		...
		// 	$.ajax({
		// 	url: "http://m1.merryriana.com/merchandise/send_data_merch",
		// 	type : "POST",
		// 	data: {
		// 				'merch_id': item.id,
		// 				'name': name,
