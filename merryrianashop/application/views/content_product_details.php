    ...
    <head>
    	...
    	<script type="text/javascript" class="init">
    		...
    		var clothing = [11, 12, 13, 15, 16, 17, 31, 34, 35, 36, 37, 38, 54, 43, 42];
			var kosong = [15, 42, 16];
    ...
    <body>
    								...
    								<div class="element-wrapper">
    									<div class="element-box">
											...
											?>
    											<div class="row">
    												<div class="col-md-6">
														<img class="card-img-top" src="https://m1salesforce.com/assets/img/merchandise/<?= $merchandise->img ?>" alt="" id="img_active"/>

														<?php if(!empty($videos->video_merchandise)) { ?>
														<video controls style="width:100%;" id="video_active" class="d-none">
															<source src="https://m1salesforce.com/assets/img/content_video/<?= $videos->video_merchandise ?>" type="video/mp4">
														</video>
														<?php } ?>
														<?php if(!empty($videos->video_merchandise)) { ?>
														<hr>
														<font style="font-weight: 600; font-size: 30px;">VIDEO</font>
														<div class="row" style="margin-top: 10px;">
																<div class="col-md-3 mb-2">
																	<div class="card" style="cursor: pointer;" onclick="set_active('video', '2')">
																		<video style="width:100%;" id="video">
																			<source src="https://m1salesforce.com/assets/img/content_video/<?= $videos->video_merchandise ?>" type="video/mp4">
																		</video>
																		<div class="card-img-overlay text-white d-flex flex-column justify-content-center">
																			<i class="fa fa-play-circle text-center" style="font-size: 60px;"></i>
																		</div>
																	</div>
																</div>
														</div>
														...
														<?php if(!empty($photos)) { ?>
														<hr>
														<font style="font-weight: 600; font-size: 30px">POSTER</font>
														<div class="row" style="margin-top: 10px;">
															<?php foreach($photos as $row){ ?>
																<div class="col-md-3 mb-2">
																	<div class="card" style="cursor: pointer;" onclick="set_active('<?=  $row->id?>', '1')">
																		<img class="card-img-top" src="https://m1salesforce.com/assets/img/content_photo/<?= $row->photo ?>" alt="" />
																	</div>
																</div>
															<?php } ?>
														</div>
		...
		<script type="text/javascript">
			...
			function set_active(id, value) {
				if(value == 1){
					$.ajax({
						url: "https://m1salesforce.com/api/mrshop/marketing_tools/active_photos/"+id,
						type: "GET",
						dataType: "json",
						success: function(results) {
							$('#img_active').attr('src', "")
							$('#img_active').attr('src', "https://m1salesforce.com/assets/img/content_photo/"+ results.photo)
							$("#img_active").removeClass("d-none");
							$("#video_active").addClass("d-none");
					...
					$("#img_active").addClass("d-none");
					$("#video_active").removeClass("d-none");
					$("#video_active")[0].play()
				}
			}
