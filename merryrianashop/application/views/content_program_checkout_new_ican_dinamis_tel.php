														...
														<div class="row">
															<div class="col-md-6">
																...
																<div class="mt-3 wajib">
																	...
																	<input class="form-control numeric" value="<?php echo (!empty($user['hp'])) ? $user['hp'] : '' ?>" maxlength="12" onkeyup="checkMobileAyah(); return false;" id="phoneayah" name="phoneayah" type="text" placeholder="contoh : 8123456789">
																...
																<div class="mt-3 wajib">
																	...
																	<input class="form-control" value="<?php echo (!empty($user['email'])) ? $user['email'] : '' ?>" id="emailayah" name="emailayah" type="text" placeholder="" onkeyup="email_validation_ayah()" style="width:100%">
															...
															<div class="col-md-6">
																...
																<div class="mt-3 wajib">
																	...
																	<input class="form-control numeric" value="<?php echo (!empty($user['hpibu'])) ? $user['hpibu'] : '' ?>" onkeyup="checkMobileIbu(); return false;" maxlength="12" id="phoneibu" name="phoneibu" type="text" placeholder="contoh : 8123456789">
																...
																<div class="mt-3 wajib">
																	...
																	<input class="form-control" value="<?php echo (!empty($user['emailibu'])) ? $user['emailibu'] : '' ?>" id="emailibu" name="emailibu" type="text" placeholder="" onkeyup="email_validation_ibu()" style="width:100%">
	...
	<script type="text/javascript">
		...
		function tambah_peserta(nama_program) {
			...
			var form_anak_baru = `<div class="col-md-6 mt-3" id="head` + jumlah_anak + `">
																...
																<div class="wajib">
																	<label for="">No HP anak<small><span style="color:red;"> *required</span></small></label>
																	<input class="form-control numeric" value="" id="nohpanak` + jumlah_anak +`" name="nohpanak[` + jumlah_anak + `]" type="text" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==12) return false;" placeholder="contoh : 8123456789" style="width:100%">
																</div>
