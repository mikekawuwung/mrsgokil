...
<head>
    ...
    <title>Cart Catering M Kitchen - Merry Riana Group</title>
...
<body class="bg-light">
    <div class="container">
        <div class="py-4 text-center">
            <h2>Silakan Pilih Batch di Bawah Ini:</h2>
            <!--<p class="lead">-->
            <!--    Minimal untuk menu yang Anda pesan adalah 3 Box. Silakan pesan.-->
            <!--</p>-->
        </div>
        
        <!--<div class="text-center mb-4 table-responsive">-->
        ...
        <!--                                            <tr>-->
        <!--                                                <td>24</td>-->
        <!--                                                <td>5 Okt - 9 Okt 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>25</td>-->
        <!--                                                <td>12 Okt - 16 Okt 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>26</td>-->
        <!--                                                <td>19 Okt - 23 Okt 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>27</td>-->
        <!--                                                <td><span style="color: red;">*</span>26 Okt - 28 Okt 2020</td>-->
        <!--                                                <td>6</td>-->
        <!--                                                <td>Rp 330.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>28</td>-->
        <!--                                                <td>2 Nov - 6 Nov 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>29</td>-->
        <!--                                                <td>9 Nov - 13 Nov 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>30</td>-->
        <!--                                                <td>16 Nov - 20 Nov 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>31</td>-->
        <!--                                                <td>23 Nov - 27 Nov 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>32</td>-->
        <!--                                                <td>30 Nov - 4 Des 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>33</td>-->
        <!--                                                <td>7 Des - 11 Des 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>34</td>-->
        <!--                                                <td>14 Des - 18 Des 2020</td>-->
        <!--                                                <td>10</td>-->
        <!--                                                <td>Rp 550.000</td>-->
        <!--                                            </tr>-->
        <!--                                            <tr>-->
        <!--                                                <td>35</td>-->
        <!--                                                <td><span style="color: red;">*</span>21 Des - 24 Des 2020</td>-->
        <!--                                                <td>8</td>-->
        <!--                                                <td>Rp 440.000</td>-->
        <!--                                            </tr>-->
        <!--                                        </table>-->
        <!--                                        <small style="color: red;"><b>*Di Minggu ini ada tanggal merah</b></small>-->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" id="jenis-paket">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="jenis-makanan">Jenis Makanan</label>
                    <select class="form-control" id="jenis-makanan">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <button id="add-to-cart" class="btn btn-primary" onclick="tambahKeranjang()">Tambahkan Ke Keranjang</button>
            </div>
        </div>
            ...
            <div class="col-md-6 order-md-1">
                ...
                <div class="needs-validation" novalidate>
                    ...
                    <div class="mb-3 wajib">
                        <label for="phone">HP <small style="color: red;">*required</small></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="country">Kelurahan <small style="color: red;">*required</small></label><img id="loader_kecamatan" style="display:none;" class="mx-2" src="<?= base_url('assets/25.gif'); ?>" width='16px' height='16px'></img>
                            <select class="custom-select d-block w-100" name="kelurahan" id="kelurahan" required>
    ...
    <script type="text/javascript">
        ...
        $('.checkbox-batch').change(function () {
            checkAddButton();
        });
        ...
        function checkAddButton() {
            var jenisPaket = $('#jenis-paket').val();
            var jenisMakanan = $('#jenis-makanan').val();
            var arrayBatch = [];
            $('input:checkbox:checked').each(function () {
                var thisVal = $(this).val();
                console.log(thisVal);
                var decodedVal = JSON.parse(thisVal);
                arrayBatch.push(decodedVal)
            });
            
            console.log(jenisPaket);
            console.log(jenisMakanan);
            console.log(arrayBatch);
            
            if(jenisPaket == 'monthly') {
                if(jenisMakanan == 'lunch' || jenisMakanan == 'dinner' || jenisMakanan == 'lunch-dinner') {
                    if(cart.length == 0) {
        ...
        function tambahKeranjang() {
            ...
            //     jumlahHari += parseInt(item.Hari);
            // })
            // console.log('jumlah hari ' + jumlahHari);
            
            var weekly = <?= json_encode($weekly) ?>;
            var monthly = <?= json_encode($monthly) ?>;
            
            jumlahHari = 0;
            if(jenisPaket == 'weekly') {
                weekly.forEach(item => {
                    jumlahHari += parseInt(item.jumlah_hari);
                })
            ...
            if(jenisMakanan == 'lunch' || jenisMakanan == 'dinner') {
                if(jenisPaket == 'monthly') {
                    switch(jumlahHari) {
                        case 17:
                            totalHarga = 935000;
                    ...
                    weekly.forEach(item => {
                        var hari = parseInt(item.jumlah_hari);
                        if(hari == 5) {
                            totalHarga += 300000;
                        } else if(hari == 4) {
                            totalHarga += 240000;
            ...
            dataProduk = {
                id: 172,
                nama: 'Catering ' + toTitleCase(jenisPaket) + ' ' + toTitleCase(jenisMakanan.replace('-', ' ')),
                jumlah: 1,
                berat: 1000,
                harga: totalHarga,
                jenisPaket: jenisPaket,
                jenisMakanan: jenisMakanan,
                arrayBatch: (jenisPaket == 'monthly') ? monthly : weekly
            }
            cart.push(dataProduk);
            $('#add-to-cart').prop('disabled', true);
            $('#jenis-paket').val(null);
            $('#jenis-makanan').val(null);
        ...
        function check_button() {
            ...
            if (empty || kode_pos == null || kode_pos == '' || kota == null || kota == '' || kecamatan == null || kecamatan == '' || cart.length == 0) {
                if (empty) {
                    console.log('1');
                    $('#submit_button').prop('disabled', true);
                } else {
        ...
        function submit_data() {
            ...
            for (var i = 0; i < cart.length; i++) {
                ...
                stringProduct += cart[i]['nama'] + ' ' + cart[i]['jumlah'] + ', ';

                stringProductDash += cart[i]['nama'] + ' - ' + cart[i]['jumlah'] + ' - ' + '0' + ', ';
                detailSize += '0,';
                ...
                objItem.nama_produk = cart[i]['nama'];
    			...
    			var objectProduct = {
    				id: cart[i]['id'],
    				productName: cart[i]['nama'],
    				jumlah: cart[i]['jumlah'],
    				berat: cart[i]['berat'],
    				harga: cart[i]['harga'],
    				batch: cart[i]['arrayBatch']
    			}
        ...
        function fetch_kota() {
		$.ajax({
			url: "<?php echo base_url('catering/list_kota'); ?>",
			type: "GET",
			dataType: "json",
			success: function(result) {
				console.log(result);
				$.each(result, function(index, item) {
          $('#kota').append('<option value="' + item.id_kota + '">' + item.nama_kota  + '</option>');
        });
...
function fetch_kecamatan() {
		...
		$.ajax({
			url: "<?php echo base_url('catering/list_kecamatan'); ?>",
			type: "get",
			dataType: "json",
			success: function(result) {
				console.log(result);
...
function fetch_kelurahan() {
		...
		$.ajax({
			url: "<?= base_url('catering/list_kelurahan'); ?>",
			type: "get",
			dataType: "json",
			success: function(result) {
				console.log(result);
            ...
            if(item.harga_ongkir == 0) {
						  $('#kelurahan').append('<option value="' + item.harga_ongkir + '">' + item.nama_kelurahan + ' | ' + 'FREE ONGKIR' + '</option>');
            } else {
						  $('#kelurahan').append('<option value="' + item.harga_ongkir + '">' + item.nama_kelurahan + ' | Rp. ' + parseInt(item.harga_ongkir).toLocaleString() + ' per hari' + '</option>');
            }
						if(index==0) {
							console.log("nol");
						}
...
$('#kecamatan').change(function() {
		fetch_kelurahan(); //kecamatan
		// fetch_harga(); //kecamatan
		$('#kelurahan').empty()	//kecamatan
		// $('#harga').empty();
		$('#harga_ongkir').empty();
		// check_button();
});

function mengupdateOngkir() {
    totalongkir = $('#kelurahan').val()*jumlahHari;
    
		$('#ongkir').html("Rp. " + (totalongkir).toLocaleString());
		var hargaTotal = parseInt(total_harga) + parseInt(totalongkir);
		$('#total').html("Rp. " + (hargaTotal).toLocaleString());
}
...
$('#kelurahan').change(function() {
		...
		// $('#harga').empty();
// 		$('#harga_ongkir').empty();
    var durasi = jumlahHari;
    totalongkir = $(this).val()*durasi;
    mengupdateOngkir()
    // var total = parseInt(totalongkir) + parseInt(subtotal);
// 		$('#harga_ongkir').val($(this).val());
// 		// check_button();
    // set_all();
});
    </script>
