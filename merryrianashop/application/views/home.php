...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/src/assets/css/shared/mrshop.css">
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/src/assets/css/demo_2/style.css">
    <!-- End Layout styles -->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/Logo_MRS_PNG-02.png" />
  </head>
  <body>
