											...
											<div class="col-md-12">
												<div class="card mb-3 w-100">
													<div class="card-header bgmerahhati text-white">
														Pesanan Anda
														<a href="<?php echo base_url('cartprogramya/list_chart'); ?>" class="btn btn-light btn-sm text-uppercase text-dark float-right">Edit Keranjang</a>
													</div>
																...
																<tbody>
																	...
																	?>
																			<tr>
																				...
																				<th scope="col"><a href="<?php echo site_url('cartprogramya/remove/' . $row['id']); ?>" style="color: red;">Hapus Program</a></th>
																			</tr>
																	<?php }
																	} ?>
																	<tr>
																	...
																	<tr>
																		...
																		<th scope="col"><b></b></th>
																		<th scope="col" id="hargaongkir-atas"></th>
																		<th scope="col"></th>
																	</tr>
																	<tr id="display-diskon-atas" style="display: none;">
																		<th scope="col"><b>Family Discount</b></th>
																		<th scope="col"><b></b></th>
																		<th style="color: red" scope="col" id="diskon-atas"></th>
																		<th scope="col"></th>
																	</tr>
																	<tr>
																		<th scope="col"><b>Total</b></th>
																		<th scope="col"><b></b></th>
																		<th scope="col" id="totalharga-atas"><b>Rp. <?= number_format($total) ?></b></th>
																		<th scope="col"></th>
																	</tr>
																</tbody>
															</table>
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="card mb-3 w-100">
													<div class="card-header bgmerahhati text-white">
														Parents Detail
														<a href="<?php echo base_url('cartprogramya/reset'); ?>" class="btn btn-light btn-sm text-uppercase text-dark float-right">Reset Form</a>
													</div>
													<div class="card-body text-black">
														<div class="row">
															<div class="col-md-6">
                                                                <div>
																	<label for="">Orang Tua 1<small><span style="color:red;"> *required</span></small></label>
																</div>
                                                                <div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="orangTua1" id="orangTua1Ayah" value="ayah">
                                                                        <label class="form-check-label" for="orangTua1Ayah">Ayah</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="orangTua1" id="orangTua1Ibu" value="ibu">
                                                                        <label class="form-check-label" for="orangTua1Ibu">Ibu</label>
                                                                    </div>
                                                                </div>
                                                                <span id="alert-radio-orang-tua" style="color: red; font-size: 10px; display:none;">Pilih salah satu terlebih dahulu</span>

																<div class="wajib">
																	<label for="">Nama<small><span style="color:red;"> *required</span></small></label>
																...
																<div class="mt-3 wajib">
																	<label>HP<small><span style="color:red;"> *required</span></small></label><br>
																	<input type="hidden" id="hpvalidayah" value="false">
																	<input class="form-control numeric" value="<?php echo (!empty($user['phone'])) ? $user['phone'] : '' ?>" maxlength="12" onkeyup="checkMobileAyah()" id="phoneayah" name="phoneayah" type="text" placeholder="contoh : 8123456789" required>
															...
															<div class="col-md-6">
                                                                <div>
																	<label for="">Orang Tua 2<small><span style="color:red;"> *required</span></small></label>
																</div>
                                                                <div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="orangTua2" id="orangTua2Ayah" value="ayah">
                                                                        <label class="form-check-label" for="orangTua2Ayah">Ayah</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="orangTua2" id="orangTua2Ibu" value="ibu">
                                                                        <label class="form-check-label" for="orangTua2Ayah">Ibu</label>
                                                                    </div>
                                                                </div>
														...
														<div class="table-responsive">
															<table class="table">
																<tbody>
																	...
																	<tr id="display-diskon" style="display: none;">
																		<th scope="col"><b>Family Discount</b></th>
																		<th scope="col"><b></b></th>
																		<th style="color: red" scope="col" id="diskon"></th>
																	</tr>
																	<tr>
																		<th scope="col"><b>Total</b></th>
																		<th scope="col"><b></b></th>
...
// 		}
		...
		$(document).ready(function() {
            ...
            $(document).on('keyup', '.numericAnak', function() {
                if (/\D/g.test(this.value)) {
                    console.log(this.value)
                    this.value = this.value.replace(/\D/g, '');
                }
			...
			items.forEach(item => {
				if (item.kategori == 'digital-class') {
					for (i = 0; i < item.quantity; i++) {
                        ...
                        programYangDipilih += item.program_name + ', ';
						tambah_peserta(item.program_name);
					}
				}
				if(item.id == 41 && item.quantity >= 2) {
				    isDiskon = true;
				    diskon = 400000;
				    totalDiskon = 400000 * (item.quantity-1);
				    var totalHarga = <?= $total ?>;
				    hargaSetelahDiskon = totalHarga - totalDiskon;
				    
			        $('#diskon').html("- Rp. " + parseInt(totalDiskon).toLocaleString());
			        $('#diskon-atas').html("- Rp. " + parseInt(totalDiskon).toLocaleString());
			        $('#display-diskon').show();
			        $('#display-diskon-atas').show();
			        $('#totalharga').html("Rp. " + parseInt(hargaSetelahDiskon).toLocaleString());
			        $('#totalharga-atas').html("Rp. " + parseInt(hargaSetelahDiskon).toLocaleString());
		...
		function swalertAmbil(title, text, confirm) {
			Swal.fire({
				...
				if (result.value) {
					...
					window.location.href = "<?php echo base_url('cartprogramya/buy/23'); ?>";
				} else {
					console.log('gak jadi');
				}
			});
		...
		function swalertTawar(title, text, confirm) {
			Swal.fire({
				...
				if (result.value) {
					console.log(result);
					console.log(result.value);
					window.location.href = "<?php echo base_url('online_program_ya'); ?>";
				} else {
					console.log('gak jadi');
				}
			});
		...
		function checkMobileAyah() {
			...
			if (phone.value.length >= 8 && phone.value.length <= 12) {
                ...
                phone.style.borderColor = badColor;
                message_mobile.style.color = badColor;
                message_mobile.innerHTML = "<br>HP tidak bisa dimulai dengan angka 0"
                hpvalidayah = "false";
                return
		...
		function tambah_peserta(nama_program) {
			...
			var form_anak_baru = `<div class="col-md-6 mt-3" id="head` + jumlah_anak + `">
																...
																<div class="mt-3 wajib">
																	...
																	<input class="form-control numeric" value="" id="usiaanak" name="usiaanak[` + jumlah_anak + `]" type="number" onKeyPress="if(this.value.length==2) return false;" placeholder="" required>
																</div>

																<div class="">
																	<label for="">No HP anak</label><br/>
																	<input class="form-control hp-ke` + jumlah_anak + ` numericAnak" value="" id="nohpanak` + jumlah_anak +`" name="nohpanak[` + jumlah_anak + `]" type="text" onKeyPress="if(this.value.length==12) return false;" placeholder="contoh : 8123456789" style="width:100%" required>
																...
																<br/><small class="email-duplicate-ke` + jumlah_anak + `" style="color: red; display:none;">Email Tidak Boleh Sama</small>
			...
			if(jumlah_anak == 0) {
		        var userData = <?php echo json_encode($user); ?>;
		        $('#catatan').val(userData.anak);
		        $('#usiaanak').val(userData.usia);
			}
        ...
        $("input[name='orangTua1']").change(function(){
            console.log('ini orang tua 1')
            $('#alert-radio-orang-tua').hide();
            console.log($(this).val());
            if($(this).val() == 'ayah') {
                $('#orangTua2Ibu').prop('checked', true);
            } else {
                $('#orangTua2Ayah').prop('checked', true);
            }
        });

        $("input[name='orangTua2']").change(function(){
            console.log('ini orang tua 2')
            console.log($(this).val());
            $('#alert-radio-orang-tua').hide();
            if($(this).val() == 'ayah') {
                $('#orangTua1Ibu').prop('checked', true);
            } else {
                $('#orangTua1Ayah').prop('checked', true);
            }
        });
		...
		function set_ongkir() {
			...
			var total = <?= $total; ?>;
			$('#hargaongkir').html("Rp. " + parseInt(harga).toLocaleString());
			$('#hargaongkir-atas').html("Rp. " + parseInt(harga).toLocaleString());
			if(isDiskon) {
			    $('#totalharga').html("Rp. " + (parseInt(harga) + parseInt(total) - parseInt(totalDiskon)).toLocaleString());
			    $('#totalharga-atas').html("Rp. " + (parseInt(harga) + parseInt(total) - parseInt(totalDiskon)).toLocaleString());
			} else {
			    $('#totalharga').html("Rp. " + (parseInt(harga) + parseInt(total)).toLocaleString());
			    $('#totalharga-atas').html("Rp. " + (parseInt(harga) + parseInt(total)).toLocaleString());
			}
		}
...
// 			var phoneibu = $('#phoneibu').val();
            ...
            var orangTua1 = $("input[name='orangTua1']:checked").val();
            var orangTua2 = $("input[name='orangTua2']:checked").val();
            var orangTua1Ayah = document.getElementById("orangTua1Ayah"); 
            console.log('ini orangTua1 ' + orangTua1);
            console.log('ini orangTua2 ' + orangTua2);
            // console.log(typeof orangTua1);
            // if(typeof orangTua1 == 'undefined') {
            //     console.log('tipe orangTua1 ' + orangTua1);
            //     orangTua1Ayah.focus();
            //     $('#alert-radio-orang-tua').show();
            // }
            var dataAyah = '';
            var dataIbu = '';
            if(orangTua1 == 'ayah') {
                dataAyah = nameayah + ', ' + phoneayah + ', ' + emailayah;
                dataIbu = nameibu + ', ' + phoneibu + ', ' + emailibu;
                
                
				// data parent
				dataParent.fatherName = nameayah;
				dataParent.fatherPhone = phoneayah;
				dataParent.fatherEmail = emailayah;

				dataParent.motherName = nameibu;
				dataParent.motherPhone = phoneibu;
				dataParent.motherEmail = emailibu;
            } else {
                dataAyah = nameibu + ', ' + phoneibu + ', ' + emailibu;
                dataIbu = nameayah + ', ' + phoneayah + ', ' + emailayah;
                
                
				// data parent
				dataParent.fatherName = nameibu;
				dataParent.fatherPhone = phoneibu;
				dataParent.fatherEmail = emailibu;

				dataParent.motherName = nameayah;
				dataParent.motherPhone = phoneayah;
				dataParent.motherEmail = emailayah;
            }
			...
			if ($('#kurir option:selected').text() != "Kurir Pilihan") {
				...
				// 	kecamatan = subdistrict.options[subdistrict.selectedIndex].text;
					...
					// data pengiriman
					kecamatanId = subdistrict.options[subdistrict.selectedIndex].value;
			...
			if (ekspedisi.includes("J&T")) {
				...
				namaEkspedisi = "JNE";
				if (ekspedisi.includes("CTCYES")) {
					layananEkspedisi = "CTCYES";
				} else if (ekspedisi.includes("CTC")) {
					layananEkspedisi = "CTC";
				} else if (ekspedisi.includes("YES")) {
					layananEkspedisi = "YES";
				} else if (ekspedisi.includes("REG")) {
					layananEkspedisi = "REG";
				} else if (ekspedisi.includes("OKE")) {
					layananEkspedisi = "OKE";
				}
			}
			...
			var dataCustomer = {
				...
				order_id: "DC-" + (Math.floor(Math.random() * 10 ** 10)).toString()
			};
			...
			for (var i = 0; i < length; i++) {
				...
				// dataItems[i]['schedules'].forEach((item, index) => {
					var short_name = dataItems[i]['short_name'];
					if(short_name in setProgramQuantity) {
						setProgramQuantity[short_name] = setProgramQuantity[short_name] + parseInt(dataItems[i]['quantity']);
					} else {
						Object.assign(setProgramQuantity, {
							[short_name]: parseInt(dataItems[i]['quantity'])
						});
					}
					
					// modul yang dipilih
					objectModul.push(short_name);
				// });
				
				// modul yang dipilih
				for(var j=0; j<parseInt(dataItems[i]['quantity']); j++) {
					arrayModul.push(objectModul);
				}
				
				// data product
				var objectProduct = {
					id: dataItems[i]['product_id'], // sub kategori id & product id
					productName: dataItems[i]['program_name'],
					jumlah: dataItems[i]['quantity'],
					berat: dataItems[i]['berat'],
					harga: dataItems[i]['price'],
					sub_kategori_id: dataItems[i]['sub_kategori_id']
				}
				...
				if(dataItems[i]['id'] == 41 && dataItems[i]['quantity'] >= 2) {
				    var item = {};
    				// stringProduct += 'Diskon' + ' ' + dataItems[i]['quantity']-1 + ', ';
    				// stringProductDash += 'Diskon' + ' - ' + dataItems[i]['quantity']-1 + ', ';
    				// detailSize += '0,';
    				// detailJumlah += dataItems[i]['quantity']-1 + ',';
    				item.id = 'DISKON';
    				item.judul = 'Diskon';
    				item.gambar = '-';
    				item.deskripsi = '-';
    				item.kategori = '-';
    				item.harga = -400000;
    				item.jumlah = dataItems[i]['quantity']-1;
    				item.berat = 0;
    				console.log(item);
    				dataProduk.push(item);
    				
    				// objItem.nama_produk = 'Diskon';
    				// objItem.jumlah = dataItems[i]['quantity'] - 1;
    				// objItem.harga = -400000;
    				// arrayItems.push(objItem);
			...
			var objectPengiriman = {
				...
				layananEkspedisi: layananEkspedisi,
				ongkir: harga,
...
// 			dataCustomer.id_buku = stringProduct;
            var index = 0;
			for (var key in setProgramQuantity) {
				programQuantity += key + ' : ' + setProgramQuantity[key];
				index++;
				if(index != Object.keys(setProgramQuantity).length) {
					programQuantity += ', ';
				}
			}
			dataCustomer.id_buku = programQuantity;
			...
			hasil.forEach(function(item) {
				...
				if(key == 'nohpanak') {
					...
					arrayInputNumber.forEach(item => {
						...
						// data student
						arrayHpAnak.push(item.getNumber());
					});
					value = [];
					value.push(array);
					// revisi ican
					...
					value = item.value;
					value.forEach(item => {
						arrayNamaAnak.push(item);
					})
				} else if(key == 'usiaanak') {
					value = item.value;
					value.forEach(item => {
						arrayUsiaAnak.push(item);
					})
				} else {
					value = item.value;
					// data student
					value.forEach(item => {
						arrayEmailAnak.push(item);	// push usia anak ke arrayEmailAnak
					})
				}
				//perubahan
				console.log("value : " + value);
			...
			dataCustomer.data_orang_tua_2 = 'Data Orang Tua 2 (' + dataIbu + ')';
			
			// data student
			var arrayStudent = [];
			var stringStudent = '';
			arrayNamaAnak.forEach((item, index) => {
				stringStudent += item + ' ' + arrayUsiaAnak[index] + ' thn';
				if(index != arrayNamaAnak.length - 1) {
					stringStudent += ', ';
				}
				...
				var objectStudent = {
					namaStudent: item,
					usiaStudent: arrayUsiaAnak[index],
					hpStudent: arrayHpAnak[index],
					emailStudent: arrayEmailAnak[index],
					modulStudent: arrayModul[index] // modul yang dipilih
				}
				arrayStudent.push(objectStudent);
			})
			dataCustomer.stringStudent = stringStudent;
// 			dataCustomer.phone = dataCustomer.nohpanak + 'Usia Anak ' + dataCustomer.usiaanak //perubahan
            ...
            for(let i=0; i<emailArray.length; i++) {
                ...
                if(counter >= 2) {
                    indexes.forEach(indexArr => {
                        duplicateIndexArray.push(indexArr);
                    })
                }
            }

            if(duplicateIndexArray.length > 0) {
                empty = true;
                duplicateIndexArray.forEach((item, index) => {
                    $('.email-ke' + index).first().focus();
                    $('.email-duplicate-ke' + index).show();
                });
            }
			...
			if(!empty) {
				...
				if(objectPengiriman.aff == "" || objectPengiriman.aff == null) {
    				$.ajax({
        				...
        				success: function(response) {
        					...
        					// ajax kiriman
            				$.ajax({
                				url: "https://m1salesforce.com/receive_data_mrdl",
                				type: "POST",
        					...
        					$.ajax({
        						url: "<?php echo base_url('cartprogramya/clear'); ?>",
        						type: "GET",
    			...
    			if ((dataCustomer.aff != '') && (dataCustomer.aff != 'ads') && (dataCustomer.aff != 'LP') && (dataCustomer.aff != 'M1')) {
					...
					$.ajax({
						...
						data: {
							// revisi ican
							'string_student': dataCustomer.stringStudent,
				// 			'id_buku': dataCustomer.id_buku + nama_peserta + 'Usia ' + usia_anak,
							...
							'total': parseInt(harga) + parseInt(total) - parseInt(totalDiskon),
                            ...
                            'id_op': item.id,
                            'program_yang_dipilih': programYangDipilih,
...
// 			});
			...
			if (nameayah != '' && hpvalidayah == "true" && emailayah != '' && emailvalidayah == "true" && nameibu != '' && emailibu != '' && phoneibu != '' && hpvalidibu == "true" && emailvalidibu == "true" && alamat != '' && $('#provinsi option:selected').text() != "-Pilih Provinsi-" && kota != '-Pilih Kota-' && typeof orangTua1 != 'undefined') {
				// $.ajax({
				// 	url: "https://leads.merryriana.com/post_data/input_merch_wordpress",
				// 	type: "POST",
				// 	data: {
