								...
								<table class="table table-striped table-hovered">
				                    ...
				                    <tbody>
				                        ...
				                        <tr class="text-center">
				                            ...
				                            <td>
				                                <?php echo $row['merch_name']; ?>
				                            </td>
				                            <!-- start here validasi sd -->
											<?php if($row['id'] == 23) { ?>
															<th>
																<!-- <?php //echo $row['quantity']; ?>  -->
																<a href="<?= base_url('cart/remove_one/' . $row['id']);?>" class="btn bgmerahhati text-white btn-sm">-</a> 
																<?php // echo $row['quantity']; ?> 
																...
																<a href="<?= base_url('cart/add_one/' . $row['id']);?>" class="btn bgmerahhati text-white btn-sm">+</a>
															<?php } ?>
															</th>
															<?php } else { ?>
															<th>
																<a href="<?= base_url('cart/remove_one/' . $row['id'] . '?Ukuran=' . $row['size']);?>" class="btn bgmerahhati text-white btn-sm">-</a> 
																<?php // echo $row['quantity']; ?> 
																	<input style="border: none;" id="uintTextBox" type="number" name="count<?= $index; ?>" min="1" max="9" size="1" value="<?= $row['quantity']; ?>" readonly></input> 
																<a href="<?= base_url('cart/add_one/' . $row['id'] . '?Ukuran=' . $row['size']);?>" class="btn bgmerahhati text-white btn-sm">+</a>
															</th>
															<?php } ?>
										...
										<tr>
				                            ...
				                            <td></td>
				                            <td></td>
				                            <td class="text-center"><button type="submit" class="btn btn-sm bgmerahhati text-white">Update Jumlah dan Size</button></td>
				                            <td></td>
				                        </tr>
				                        <?php } ?>
				                        </form>
