...
<body>
												...
												<div class="card mb-3 w-100">
													...
													<div class="card-body text-black">
														...
														<div class="mt-3 wajib">
															...
															<input class="form-control numeric" value="<?php echo (!empty($user['phone'])) ? $user['phone'] : '' ?>" id="phoneayah" name="phoneayah" type="text" placeholder="">
														</div>

														<div class="mt-3">
															<label for="">Email Ayah</label>
															<input class="form-control" value="<?php echo (!empty($user['emailayah'])) ? $user['emailayah'] : '' ?>" id="emailayah" name="emailayah" type="text" placeholder="" style="width:100%">
														</div>
														...
														<div class="row">
															<div class="col-md-12">
																<div class="wajib">
																	...
																	<input class="form-control" value="<?php echo (!empty($user['nama'])) ? $user['nama'] : '' ?>" id="catatan" name="catatan" type="text" placeholder="" style="width:100%">
																</div>

																<div class="mt-3 wajib">
																	<label>Usia anak<small><span style="color:red;"> *required</span></small></label>
																	<input class="form-control numeric" value="<?php echo (!empty($user['usiaanak'])) ? $user['usiaanak'] : '' ?>" id="usiaanak" name="usiaanak" type="text" placeholder="">
																</div>

																<div class="wajib">
																	<label for="">No HP anak<small><span style="color:red;"> *required</span></small></label>
																	<input class="form-control numeric" value="<?php echo (!empty($user['nohpanak'])) ? $user['nohpanak'] : '' ?>" id="nohpanak" name="nohpanak" type="text" placeholder="" style="width:100%">
																</div>


																<div class="mt-3 wajib">
																	<label for="">Email<small><span style="color:red;"> *required</span></small></label>
																	<input class="form-control" value="<?php echo (!empty($user['emailanak'])) ? $user['emailanak'] : '' ?>" id="emailanak" name="emailanak" type="text" placeholder="">
																</div>
																	...
																	if (!empty($items)) {
																		...
																		foreach ($items as $row) {
																			...
																			<tr>
																				...
																				<th scope="col"><a href="<?php echo site_url('cartprogram/remove/' . $row['id']); ?>" style="color: red;">Hapus Program</a></th>
																			</tr>
																		<?php }
																} ?>
																	<tr>
	...
	<script type="text/javascript">
		...
		$('#pay-button').click(function(event) {
			...
			var nohpanak = $('#nohpanak').val();
			var emailanak = $('#emailanak').val();
