					...
					<div class="row">
						...
						<div class="col-md-3" id="main">
							...
							<div class="card" style="margin-bottom:10px;">
								<a href="<?= base_url('online_program_ya/detail?id=' . $product->id) ?>"><img class="card-img-top" src="<?= base_url('assets/img/merchandise/'. $product->img); ?>" alt=""/></a>
								<div class="card-body">
								<a href="<?= base_url('online_program_ya/detail?id=' . $product->id) ?>">
