                    ...
                    <div class="element-wrapper">
                        <div class="element-box">
                        	<div class="element-info">
                        		<a href="<?= base_url('online_program_ican'); ?>" class="btn btn-default btn-sm borbgmerahhati text-white"><i class="fa fa-arrow-left text-white"></i>
                        			Kembali
                        		</a>
							</div>
                            <?php 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
									...
									<h6 class="mt-4">Jadwal Program :</h6>
									<table cellpadding="5px" class="mb-4">
									<?php foreach($schedules as $index => $jadwal) { ?>
										<tr>
											<td><?= ++$index; ?>.</td>
											<td><?= $jadwal['program_name']; ?></td>
											<td>: <?= $jadwal['program_date']; ?></td>
										</tr>
										<!-- <tr>
											<td>2.</td>
											<td>Find Your Passion</td>
											<td>: 29 Agustus 2020</td>
										</tr> -->
									<?php } ?>
									</table>
									<?php } ?>
